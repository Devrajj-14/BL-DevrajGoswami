...
/*
   converts whole text to uppercase using charAt + ascii,
   compares with built-in toUpperCase().
*/
public class UppercaseConversionCustomVsBuiltIn {

    static String myUpper(String text) {
        String out = "";
